...
class PMACamera:
    ...
    def from_file_system(cls, path_to_images: str):
        """
        Alternative classmethod to create an instance of a :class:`PMACamera` object using a :data:`FileSystemCamera`
        """
    ...
    def from_usb(cls, camera_device_id: int = 0):
        """
        Alternative classmethod to create an instance of a :class:`PMACamera` object using a :data:`UsbCamera`
        """
    ...
    def capture_image(self, output_file_name=""):
        ...
        .. note::
            If no :data:`output_file_name` argument is provided, images will be stored in `~/PMACamera`.
    ...
    def start_video_capture(self, output_file_name="", fps=20.0, resolution=None):
        ...
        .. note::
            If no :data:`output_file_name` argument is provided, video will be stored in `~/PMACamera`.

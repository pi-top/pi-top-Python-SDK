...
class PMAUltrasonicSensor(SmoothedInputDevice):
    ECHO_LOCK = Lock()

    def __init__(
            self, port_name, queue_len=9, max_distance=3,
            threshold_distance=0.3, partial=False):
        super(PMAUltrasonicSensor, self).__init__(
    ...
    def close(self):
        ...
        the :keyword:`with` statement. For example:
            ...
            ...
        """
        super(PMAUltrasonicSensor, self).close()
    ...
    def value(self):
        ...
        """
        return super(PMAUltrasonicSensor, self).value
    ...
    def pin(self):
        ...
        """
        return super(PMAUltrasonicSensor, self).pin
    ...
    def _read(self):
        ...
        with PMAUltrasonicSensor.ECHO_LOCK:
...
PMAUltrasonicSensor.when_out_of_range = PMAUltrasonicSensor.when_activated
PMAUltrasonicSensor.when_in_range = PMAUltrasonicSensor.when_deactivated
PMAUltrasonicSensor.wait_for_out_of_range = PMAUltrasonicSensor.wait_for_active
PMAUltrasonicSensor.wait_for_in_range = PMAUltrasonicSensor.wait_for_inactive

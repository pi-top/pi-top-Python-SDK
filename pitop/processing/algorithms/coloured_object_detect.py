...
def process_frame_for_object(frame, image_format="PIL", scale_factor=0.5):
    cv2 = import_opencv()
    ...
    return dotdict({
        ...
        "line_center": centroid,  # deprecated
        "robot_view": robot_view_img,
        "rectangle_dimensions": rectangle_dimensions,  # deprecated
        "object_dimensions": rectangle_dimensions,

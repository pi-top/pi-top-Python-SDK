...
def center_reposition(center, frame):
    """Reposition center so that (0, 0) is in the middle of the frame and y is pointing up instead
    of the OpenCV standard where (0, 0) is at the top left and y is pointing down.

...
class PID(object):
    ...
    def components(self):
        ...
        Useful for visualizing what the controller is doing or when
    ...
    @property
    def auto_mode(self):
        """Whether the controller is currently enabled (in auto mode) or
        not."""
    ...
    def reset(self):
        ...
        This sets each term to 0 as well as clearing the integral, the
        last output and the last input (derivative calculation).
        """
        self._proportional = 0
        self._integral = 0
        self._derivative = 0

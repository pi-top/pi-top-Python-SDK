            ...
            SendInput(
                ...
                ctypes.byref(
                    INPUT(
                        type=INPUT.MOUSE,
                        value=INPUT_union(
                            mi=MOUSEINPUT(dwFlags=MOUSEINPUT.WHEEL, mouseData=int(dy))
                        ),
                    )
                ),
                ctypes.sizeof(INPUT),
            ...
            SendInput(
                ...
                ctypes.byref(
                    INPUT(
                        type=INPUT.MOUSE,
                        value=INPUT_union(
                            mi=MOUSEINPUT(dwFlags=MOUSEINPUT.HWHEEL, mouseData=int(dx))
                        ),
                    )
                ),
                ctypes.sizeof(INPUT),
    ...
    def _press(self, button):
        SendInput(
            ...
            ctypes.byref(
                INPUT(
                    type=INPUT.MOUSE,
                    value=INPUT_union(mi=MOUSEINPUT(dwFlags=button.value[1])),
                )
            ),
            ctypes.sizeof(INPUT),
        )
    ...
    def _release(self, button):
        SendInput(
            ...
            ctypes.byref(
                INPUT(
                    type=INPUT.MOUSE,
                    value=INPUT_union(mi=MOUSEINPUT(dwFlags=button.value[0])),
                )
            ),
            ctypes.sizeof(INPUT),
        )

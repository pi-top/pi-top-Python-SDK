...
class Key(enum.Enum):
    """A class representing various buttons that may not correspond to letters.
    This includes modifier keys and function keys.
...
class Controller(object):
    ...
    class InvalidCharacterException(Exception):
        ...
        string passed to :meth:`Controller.type`.

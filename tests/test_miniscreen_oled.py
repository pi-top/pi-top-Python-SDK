...
modules["pitoputils"] = MagicMock()

mock_sys_info = modules["pitoputils.sys_info"] = MagicMock()
mock_sys_info.is_pi = MagicMock(return_value=False)

mock_curr_session_info = modules["pitoputils.current_session_info"] = MagicMock()
mock_curr_session_info.get_first_display = MagicMock(return_value=None)

modules["pitoputils.ptdm_message"] = MagicMock()
modules["pitoputils.logger"] = MagicMock()
